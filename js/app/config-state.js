...
const el = {
  ...
  tutorPage: document.querySelector("#tutorPage"),
  ...
  tutorPageBtn: document.querySelector("#tutorPageBtn"),
  ...
  tutorQuestionInput: document.querySelector("#tutorQuestionInput"),
  tutorSubjectInput: document.querySelector("#tutorSubjectInput"),
  tutorDepthInput: document.querySelector("#tutorDepthInput"),
  tutorSignalList: document.querySelector("#tutorSignalList"),
  tutorAnswerBadge: document.querySelector("#tutorAnswerBadge"),
  tutorTextAnswer: document.querySelector("#tutorTextAnswer"),
  tutorDiagram: document.querySelector("#tutorDiagram"),
  tutorVideoScript: document.querySelector("#tutorVideoScript"),
