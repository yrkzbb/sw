...
- [x] **多智能体资源生成**（`LINGXI_LEARNING_RESOURCES`）：需求分析师、知识讲解、思维导图、练习命题、阅读拓展、多模态脚本、代码实操、审核整合等 Agent 协作，优先围绕本次输入主题生成 6 类个性化学习资料  
...
6. **多智能体资源生成**
   顶部“资源”页面以学生本次输入的课程/短板/需求为主上下文，学习画像只用于调整难度和讲解风格；页面显式展示 8 个 Agent 的协作分工，并保存专业课程讲解文档、知识点思维导图、不同类型练习题目、拓展阅读材料、多模态教学视频/动画脚本、代码类实操案例等 6 类资源。
