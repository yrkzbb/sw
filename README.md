...
6. **多智能体资源生成**
   顶部“资源”页面以学生本次输入的课程/短板/需求为主上下文，学习画像只用于调整难度和讲解风格；页面显式展示 8 个 Agent 的协作分工。用户可多选知识讲解、思维导图、练习命题、阅读拓展、多模态脚本、代码实操等 Agent，只生成所选资源；若未选择 Agent，则默认生成完整 6 类资源。需求分析师和审核整合 Agent 始终作为编排与质量检查节点参与。
